...
<body id="page-top" class="hidden">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#"  data-target="#logoutModal" data-toggle="modal" aria-expanded="true" aria-controls="collapsePages">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
            <h3 class="text-center">Recibos de sueldo</h3>
            <div class="container">
                        ...
                        while(!feof($file))
                        {
                            ...
                            if($legajo == $datos[0])
                            {
                                for ( $i = 1; $i < ($num); $i++)
                                {
                                  ...
                                  <div class='card-body'>
                                    <h5 class='card-title'>Recibo de sueldo</h5>
                                    <a href='{$datos[$i]}' class='card-text'>Ver/Descargar</a>
                                  </div>
                                </div>";
                                }
                            }
                            ...
                            {
                                echo "<p class='text-center>Aún no se cargó ningún recibo</p>'";
                            }
                        }
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Los cambios no guardados, no serán modificados.</div>
