    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Editar datos del empleado</h1>
          <p class="mb-4">Una vez realizados los cambios, no se olvide de "Guardar cambios"</p>
              ...
              <div class="container">
                 <div class="text-center">
                    <div class="row">
                        ...
                        <input type="text" value="<?php echo $puesto?>" name="puesto">
                        </div>
                        <div class="container">
