    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Registro acerca de los movimientos realizados hacia los empleados</p>
              ...
              <div class="container-fluid">
                   ...
                   <?php
                    ...
                    while(!feof($file))
                    {
                        ...
                        if($datos[3] == "MODIFICAR")
                        {
                            $accion = "SE MODIFICÓ A ";
                        }
                      ...
                      <div class='card-body'>
                        ...
                        <p class='card-text'>{$accion}{$datos[0]} {$datos[1]} de legajo {$datos[2]}</p>
                        <p class='card-text'>{$datos[4]}:{$datos[5]}</p>
                        <p class='card-text'>{$datos[6]}/{$datos[7]}/{$datos[8]}</p>
                      </div>
                    </div>";
                    }
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Los cambios no guardadis, no serán modificados.</div>
        <div class="modal-footer">
